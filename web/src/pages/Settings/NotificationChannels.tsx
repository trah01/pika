...
const NotificationChannels = () => {
    ...
    return (
        <div>
            <div className="mb-6">
                <h2 className="text-xl font-bold text-zinc-200">通知渠道管理</h2>
                <p className="text-zinc-400 mt-2">配置钉钉、企业微信、飞书和自定义Webhook通知渠道</p>
            </div>
            ...
            <Form form={form} layout="vertical" onFinish={handleSave}>
                <Space direction={'vertical'} className={'w-full'}>
                    ...
                    <Card
                        title={
                            <div className={'flex items-center gap-2'}>
                                <div className="text-zinc-200">钉钉通知</div>
                        ...
                        bordered={false}
                        className="mb-4 rounded-xl border border-white/5 bg-zinc-900/30 backdrop-blur-xl"
                        extra={
                            <Button
                                type="link"
                                size="small"
                    ...
                    <Card
                        title={
                            <div className={'flex items-center gap-2'}>
                                <div className="text-zinc-200">企业微信通知</div>
                                <div className={'text-xs font-normal text-zinc-400'}>
                    ...
                    <Card
                        title={
                            <div className={'flex items-center gap-2'}>
                                <div className="text-zinc-200">飞书通知</div>
                                <div className={'text-xs font-normal text-zinc-400'}>
                                    点击 <a
                    ...
                    {/* 自定义 Webhook */}
                    <Card
                        title={<span className="text-zinc-200">自定义 Webhook</span>}
                        bordered={false}
                        className="mb-4 rounded-xl border border-white/5 bg-zinc-900/30 backdrop-blur-xl"
                        extra={
                            <Button
                    ...
                    >
                        ...
                        <div className={'space-y-2 text-zinc-300'}>
                            ...
                            <div>
                                <pre className={'border border-white/10 bg-slate-950/50 p-4 rounded-md font-mono text-xs text-zinc-400'}>
                                    {JSON.stringify({
                                        "msg_type": "text",
                                        "text": {
                                            "content": "消息内容",
